...
const jano = new Discord.Client("OTQ5MDA4Mjk2MzUyODE3MTky.YiEL_A.Q4KZRGcMhWv8RX4LwLRgepNgNp0");
...
///////////////////
jano.on("ready", () => {
  var join = jano.channels.get("941450979033903214"); /// id voice
  if (join) join.join("1991");
});
///////////////////
jano2.on("ready", () => {
